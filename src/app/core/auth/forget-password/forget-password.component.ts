...
//Signals syntax
verifyEmail:WritableSignal<FormGroup> = signal(this.fb.group({
      email: [null, [Validators.required, Validators.email]]
    }));
verifyCode:WritableSignal<FormGroup> = signal(this.fb.group({
      resetCode: [null, [Validators.required]]
    }));
resetPassword:WritableSignal<FormGroup> = signal(this.fb.group({
      email: [null, [Validators.required, Validators.email]],
